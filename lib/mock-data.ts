...
export const mockResidences: Residence[] = [
  ...
  },
  {
    ...
    dataRegisto: "08/03/2026",
    status: "aprovada",
    coordenadas: { lat: -12.7700, lng: 15.7300 },
    foto: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=400&h=300&fit=crop",
  },
  {
    id: "RES-1018",
  ...
  },
  {
    ...
    dataRegisto: "06/03/2026",
    status: "rejeitada",
    coordenadas: { lat: -12.7800, lng: 15.7250 },
    foto: "https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=400&h=300&fit=crop",
  },
  {
    id: "RES-1016",
    ...
    dataRegisto: "05/03/2026",
    status: "pendente",
    coordenadas: { lat: -12.7620, lng: 15.7380 },
    foto: "https://images.unsplash.com/photo-1600573472591-ee6c8e695f4d?w=400&h=300&fit=crop",
  },
  {
    id: "RES-1015",
    ...
    dataRegisto: "04/03/2026",
    status: "aprovada",
    coordenadas: { lat: -12.7680, lng: 15.7450 },
    foto: "https://images.unsplash.com/photo-1600047509807-ba8f99d2cdde?w=400&h=300&fit=crop",
  },
  {
    id: "RES-1014",
    ...
    dataRegisto: "03/03/2026",
    status: "pendente",
    coordenadas: { lat: -12.7750, lng: 15.7350 },
    foto: "https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=400&h=300&fit=crop",
  },
]
...
export function getResidencesByStatus(status: "pendente" | "aprovada" | "rejeitada") {
...
export function getStats() {
  return {
    ...
    aprovadas: mockResidences.filter((r) => r.status === "aprovada").length,
